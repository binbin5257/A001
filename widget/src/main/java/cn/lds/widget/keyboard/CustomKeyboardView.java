package cn.lds.widget.keyboard;
...
public class CustomKeyboardView extends KeyboardView implements KeyboardView.OnKeyboardActionListener {
    ...
    private void init( Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.KeyboardView,
                defStyleAttr, 0);
        mDeleteDrawable = a.getDrawable(R.styleable.KeyboardView_deleteDrawable);
        mDeleteBackgroundColor = a.getColor(
                R.styleable.KeyboardView_deleteBackgroundColor, Color.TRANSPARENT);
        mDeleteWidth = a.getDimensionPixelOffset(R.styleable.KeyboardView_deleteWidth,
                -1);
        mDeleteHeight = a.getDimensionPixelOffset(R.styleable.KeyboardView_deleteHeight,
                -1);
        a.recycle();

...
public class CalendarLayout extends LinearLayout {
    ...
    public boolean expand() {
        ...
        if(mOnCalendarLayoutToggleListener != null){
            mOnCalendarLayoutToggleListener.expand();
        }
    ...
    private OnCalendarLayoutToggleListener mOnCalendarLayoutToggleListener;

    public void setOnCalendarLayoutToggleListener( OnCalendarLayoutToggleListener onCalendarLayoutToggleListener ) {
        this.mOnCalendarLayoutToggleListener = onCalendarLayoutToggleListener;
    }

    public interface OnCalendarLayoutToggleListener{
        void expand();
        void shrink();
    }
    ...
    public boolean shrink() {
        ...
        if(mOnCalendarLayoutToggleListener != null){
            mOnCalendarLayoutToggleListener.shrink();
        }
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mContentView,

...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter {
   ...
   public BaseRecyclerAdapter(Context context) {
    ...
    static abstract class OnClickListener implements View.OnClickListener,View.OnLongClickListener {
        @Override
        ...
        public boolean onLongClick(View v) {
            RecyclerView.ViewHolder holder = (RecyclerView.ViewHolder) v.getTag();
            onLongClick(holder.getAdapterPosition(), holder.getItemId());
            return true;
        }

        public abstract void onClick(int position, long itemId);
        public abstract void onLongClick(int position, long itemId);
    }

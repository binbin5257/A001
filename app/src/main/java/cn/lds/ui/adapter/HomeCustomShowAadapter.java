...
public class HomeCustomShowAadapter extends RecyclerView.Adapter<HomeCustomShowAadapter.ViewHolder> {

    private List<HomeCustomTable> mHomeCustomTables;
    private int fuelType = 2;
    private Context context;

    public HomeCustomShowAadapter(List<HomeCustomTable> homeCustomTables) {
    ...
    public void onBindViewHolder( ViewHolder holder, final int position ) {
        ...
        holder.iconIv.setImageResource(R.drawable.ic_remove_circle);
        holder.iconLl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick( View v ) {
                if(onButtonClickListener != null){
                    onButtonClickListener.removeShowItem(position);
                }
            }
        });
    ...
    public interface OnButtonClickListener{
        void removeShowItem(int position);
    }
